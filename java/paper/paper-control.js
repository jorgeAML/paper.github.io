$(document).ready(function () {
	...
	$("<nav/>", {
		...
		"style": "background-image: url(./textures/shattered-island.gif); border-bottom: 2px solid #e5e6eb; box-shadow: 0px 1px 1px 1px #afafaf;",
	});
	$("<div/>",{
		href: "index_histo.html",
		"appendTo": ".nav-insert",
	...
	$("<div/>", {
		...
		"style": "background-image: url(./textures/shattered-island.gif);",
	...
	$("<div/>", {
		...
		html: "<img class='img-footer' src='pictures/papertheme4.png'>",
	});
	$("<div/>", {
		href: "index_histo.html",
		"appendTo": ".row",
	...
	$("<div/>", {
		...
		"style": "float: left; font-family: 'Neucha', cursive; margin-top: -4%; padding: 8px;",
	...
	$(".spanfooter").find("span").eq(6).html("<i class='icon-htmlfive'</i>").attr({
		"style": "color: #afafaf; font-size: 12px;",
		"class": "icon-color",
	...
	$("<div/>", {
		...
		html: "Made with <i class='icon-student-school' style='color: #f9fafc;'></i> and <i class='icon-heart' style='color: #e0301e;'></i> by <a class='cap-gold' href='https://github.com/jorgeAML'> <i class='icon-squaregithub'></i> AML Productions.</a>",
		"style": "color: #c0c5ce;",
